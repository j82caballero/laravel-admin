...
return [
    ...
    */
    ...
    | it will check only if the users has attached that role/permission ignoring the team.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the array that contains the information of the users models.
    | This information is used in the add-trait command, and for the roles and
    | permissions relationships with the possible users models.
    |
    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            /**
             * Redirects the users to the given url.
